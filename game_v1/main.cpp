...
int main(int argc, char const *argv[])
{
    ...
    sf::Texture texture;
    if (!texture.loadFromFile("img/planet.png"))
    // if (!texture.loadFromFile("img/rocket2.jpg"))
    // if (!texture.loadFromFile("img/rocket_white.png"))
    // if (!texture.loadFromFile("img/rocket_white (1).png"))
    // if (!texture.loadFromFile("img/fire.png"))
    {
        // error...
    }
